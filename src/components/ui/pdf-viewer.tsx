...
import { ScrollArea } from "@/components/ui/extend/scroll-area"
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from "@/components/ui/extend/select"
...
function getPdfWorkerUrl(_pdfjsVersion: string) {
  // Self-hosted (copied from node_modules/pdfjs-dist/legacy/build) to avoid
  // CORS failures against unpkg; keep in sync when bumping pdfjs-dist.
